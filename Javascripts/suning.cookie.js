...
if ($request.url.match(/\/ids\/login/)) {
  ...
  chavy.msg(`${cookieName}`, '鑾峰彇Cookie: 鎴愬姛 (鐧诲綍閾炬帴)', '')
  chavy.log(`鉂� ${cookieName} 鑾峰彇Cookie: 鎴愬姛, VAL_loginurl: ${VAL_loginurl}`)
  chavy.log(`鉂� ${cookieName} 鑾峰彇Cookie: 鎴愬姛, VAL_loginbody: ${VAL_loginbody}`)
  chavy.log(`鉂� ${cookieName} 鑾峰彇Cookie: 鎴愬姛, VAL_loginheader: ${VAL_loginheader}`)
  ...
  chavy.msg(`${cookieName}`, '鑾峰彇Cookie: 鎴愬姛 (姣忔棩绛惧埌)', '')
  chavy.log(`鉂� ${cookieName} 鑾峰彇Cookie: 鎴愬姛, VAL_signurl: ${VAL_signurl}`)
  chavy.log(`鉂� ${cookieName} 鑾峰彇Cookie: 鎴愬姛, VAL_signheader: ${VAL_signheader}`)
  ...
  chavy.msg(`${cookieName}`, '鑾峰彇Cookie: 鎴愬姛 (姣忔棩绾㈠寘)', '')
  chavy.log(`鉂� ${cookieName} 鑾峰彇Cookie: 鎴愬姛, VAL_signweburl: ${VAL_signweburl}`)
  chavy.log(`鉂� ${cookieName} 鑾峰彇Cookie: 鎴愬姛, VAL_signwebheader: ${VAL_signwebheader}`)
  ...
  chavy.msg(`${cookieName}`, '鑾峰彇Cookie: 鎴愬姛 (澶╁ぉ浣庝环)', '')
  chavy.log(`鉂� ${cookieName} 鑾峰彇Cookie: 鎴愬姛, VAL_signgameurl: ${VAL_signgameurl}`)
  chavy.log(`鉂� ${cookieName} 鑾峰彇Cookie: 鎴愬姛, VAL_signgameheader: ${VAL_signgameheader}`)
  ...
  chavy.msg(`${cookieName}`, '鑾峰彇Cookie: 鎴愬姛 (鏌ヨ澶╁ぉ浣庝环)', '')
  chavy.log(`鉂� ${cookieName} 鑾峰彇Cookie: 鎴愬姛, VAL_signgetgameurl: ${VAL_signgetgameurl}`)
  chavy.log(`鉂� ${cookieName} 鑾峰彇Cookie: 鎴愬姛, VAL_signgetgameheader: ${VAL_signgetgameheader}`)
}
